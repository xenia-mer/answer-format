...
def main():
    input_file = "data/response_collection/bbq_open/bbq_llama8b_open_responses.csv"
    original_mc_file = "data/bbq/bbq_gender_closed-ended.csv"
    output_file = "data/open_annotation/bbq_llama8b_open_responses_annotation.csv"
    ...
    for row in tqdm(open_rows, desc="BBQ Llama8B Open questions Qwen annotation"):
