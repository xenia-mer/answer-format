...
def main():
    input_file = "data/response_collection/opinion_qa_open/opinion_qa_llama8b_open_responses.csv"
    original_mc_file = "data/opinion_qa/opinion_qa_gender.csv"
    output_file = "data/open_annotation/opinion_qa_llama8b_open_responses_annotation.csv"
    ...
    for row in tqdm(open_rows, desc="OpinionQA Llama8B Open questions Qwen annotation"):
        key = row["key"]
