...
df_responses = pd.read_csv("data/response_collection/bbq_closed-ended/bbq_llama8b_closed-ended_responses.csv", sep=',')
...
df_disambig.to_csv("data/bbq_analysis/bbq_closed-ended/bbq_llama8b_closed-ended_responses_labelled_disambig.csv", index=False)
df_ambig.to_csv("data/bbq_analysis/bbq_closed-ended/bbq_llama8b_closed-ended_responses_labelled_ambig.csv", index=False)