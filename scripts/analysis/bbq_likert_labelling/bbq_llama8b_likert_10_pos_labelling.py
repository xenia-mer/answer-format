...
df_responses = pd.read_csv("data/response_collection/bbq_likert/bbq_llama8b_likert_10_pos.csv", sep=',')
...
df_disambig.to_csv("data/bbq_analysis/bbq_likert/bbq_llama8b_likert_10_pos_responses_labelled_disambig.csv", index=False)
df_ambig.to_csv("data/bbq_analysis/bbq_likert/bbq_llama8b_likert_10_pos_responses_labelled_ambig.csv", index=False)