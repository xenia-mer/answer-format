...
df_responses = pd.read_csv("data/open_annotation/bbq_gemma12b_open_responses_annotation.csv", sep=',')
...
df_disambig.to_csv("data/bbq_analysis/bbq_open/bbq_gemma12b_open-ended_responses_labelled_disambig.csv", index=False)
df_ambig.to_csv("data/bbq_analysis/bbq_open/bbq_gemma12b_open-ended_responses_labelled_ambig.csv", index=False)