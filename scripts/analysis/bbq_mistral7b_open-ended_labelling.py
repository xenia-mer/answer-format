...
df_responses = pd.read_csv("data/open_annotation/bbq_mistral7b_open_responses_annotation.csv", sep=',')
...
cols_to_keep = [
    'example_id', 'question_id', 'question_polarity', 'context_condition', 'reasoning_condition', 'sample_id', 'ground_truth', 'annotated_label_letter'
    ]
...
df_disambig.to_csv("data/bbq_analysis/bbq_open/bbq_mistral7b_open-ended_responses_labelled_disambig.csv", index=False)
df_ambig.to_csv("data/bbq_analysis/bbq_open/bbq_mistral7b_open-ended_responses_labelled_ambig.csv", index=False)