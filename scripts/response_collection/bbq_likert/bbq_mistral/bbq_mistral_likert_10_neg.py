...
def main():
    input_file = "data/bbq/bbq_likert/bbq_gender_likert_10_neg.csv"
    output_file = "data/response_collection/bbq_likert/bbq_mistral7b_likert_10_neg.csv"
    ...
    for row in tqdm(rows, desc="BBQ Mistral7B Likert10neg questions"):
