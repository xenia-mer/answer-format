...
def main():
    input_file = "data/bbq/bbq_likert/bbq_gender_likert_5_pos.csv"
    output_file = "data/response_collection/bbq_likert/bbq_mistral7b_likert_5_pos.csv"
    ...
    for row in tqdm(rows, desc="BBQ Mistral7B Likert5pos questions"):
