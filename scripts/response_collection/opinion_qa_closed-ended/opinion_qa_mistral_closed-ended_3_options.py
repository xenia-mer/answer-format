...
def main():
    input_file = "data/opinion_qa/opinion_qa_closed-ended/opinion_qa_gender_3_options_named_permutations.csv"
    output_file = "data/response_collection/opinion_qa_closed-ended/opinion_qa_mistral7b_closed-ended_3_options.csv"
    ...
    for row in tqdm(rows, desc="OpinionQA Mistral7B Closed-ended 3-option questions"):
        id = row["id"]
        key = row["key"]
