...
def main():
    ...
    output_file = "data/response_collection/opinion_qa_closed-ended/opinion_qa_gemma12b_closed-ended_4_options.csv"
    ...
    for row in tqdm(rows, desc="OpinionQA Gemma12B Closed-ended 4-option questions"):
        id = row["id"]
        key = row["key"]
