...
def main():
    ...
    output_file = "data/response_collection/opinion_qa_closed-ended/opinion_qa_gemma12b_closed-ended_6_options.csv"
    ...
    for row in tqdm(rows, desc="OpinionQA Gemma12B Closed-ended 6-option questions"):
        id = row["id"]
        key = row["key"]
