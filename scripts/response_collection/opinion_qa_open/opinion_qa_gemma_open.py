...
def main():
    ...
    output_file = "data/response_collection/opinion_qa_open/opinion_qa_gemma12b_open_responses.csv"
    ...
    for row in tqdm(rows, desc="OpinionQA Gemma12B Open-ended questions"):
        id = row["id"]
        key = row["key"]
