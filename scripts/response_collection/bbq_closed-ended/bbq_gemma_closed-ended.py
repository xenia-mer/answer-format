...
def main():
    ...
    output_file = "data/response_collection/bbq_closed-ended/bbq_gemma12b_closed-ended_responses.csv"
    ...
    for row in tqdm(rows, desc="BBQ Gemma12B Closed-ended questions"):
