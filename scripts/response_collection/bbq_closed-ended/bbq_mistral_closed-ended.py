...
def main():
    ...
    output_file = "data/response_collection/bbq_closed-ended/bbq_mistral7b_closed-ended_responses.csv"
    ...
    for row in tqdm(rows, desc="BBQ Mistral7B Closed-ended questions"):
