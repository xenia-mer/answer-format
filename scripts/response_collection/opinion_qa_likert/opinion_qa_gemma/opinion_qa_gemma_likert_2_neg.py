...
def main():
    ...
    output_file = "data/response_collection/opinion_qa_likert/opinion_qa_gemma12b_likert_2_neg.csv"
    ...
    for row in tqdm(rows, desc="OpinionQA Gemma12B Likert2neg questions"):
        example_id = row["id"]
