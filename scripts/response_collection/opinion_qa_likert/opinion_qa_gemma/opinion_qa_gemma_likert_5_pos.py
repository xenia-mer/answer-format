...
def main():
    ...
    output_file = "data/response_collection/opinion_qa_likert/opinion_qa_gemma12b_likert_5_pos.csv"
    ...
    for row in tqdm(rows, desc="OpinionQA Gemma12B Likert5pos questions"):
        example_id = row["id"]
