...
def main():
    ...
    output_file = "data/response_collection/opinion_qa_likert/opinion_qa_llama8b_likert_10_neg.csv"
    ...
    for row in tqdm(rows, desc="OpinionQA Llama8B Likert10neg questions"):
        example_id = row["id"]
