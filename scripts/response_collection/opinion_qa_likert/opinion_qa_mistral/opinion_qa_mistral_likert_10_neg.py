...
def main():
    input_file = "data/opinion_qa/opinion_qa_likert/opinion_qa_gender_likert_10_neg.csv"
    output_file = "data/response_collection/opinion_qa_likert/opinion_qa_mistral7b_likert_10_neg.csv"
    ...
    for row in tqdm(rows, desc="OpinionQA Mistral7B Likert10neg questions"):
        example_id = row["id"]
