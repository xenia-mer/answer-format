...
def main():
    ...
    output_file = "data/response_collection/opinion_qa_likert/opinion_qa_mistral7b_likert_4_neg.csv"
    ...
    for row in tqdm(rows, desc="OpinionQA Mistral7B Likert4neg questions"):
        example_id = row["id"]
