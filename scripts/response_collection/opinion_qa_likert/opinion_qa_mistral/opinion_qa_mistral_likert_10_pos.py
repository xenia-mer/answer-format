...
def main():
    input_file = "data/opinion_qa/opinion_qa_likert/opinion_qa_gender_likert_10_pos.csv"
    output_file = "data/response_collection/opinion_qa_likert/opinion_qa_mistral7b_likert_10_pos.csv"
    ...
    for row in tqdm(rows, desc="OpinionQA Mistral7B Likert10pos questions"):
        example_id = row["id"]
        question_key = row["key"]
        option_text = row["option"]
        likert_question = row["likert_question"]
