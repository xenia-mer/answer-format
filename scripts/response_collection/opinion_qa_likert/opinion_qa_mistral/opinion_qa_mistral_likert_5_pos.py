...
def main():
    input_file = "data/opinion_qa/opinion_qa_likert/opinion_qa_gender_likert_5_pos.csv"
    output_file = "data/response_collection/opinion_qa_likert/opinion_qa_mistral7b_likert_5_pos.csv"
    ...
    for row in tqdm(rows, desc="OpinionQA Mistral7B Likert5pos questions"):
        example_id = row["id"]
